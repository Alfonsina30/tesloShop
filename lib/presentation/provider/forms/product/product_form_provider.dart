...
///--- validate if formProduct is valid, 
///--- use a map that change with the state of provider and after is send to productsProvider when user to tap ok SaveButton
...
///--- add to ProductForm the previus state + path of new image added [...state.images, path ]
