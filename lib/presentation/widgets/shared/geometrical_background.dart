...
/// is a widget with stack that atack another widget was it send as property class
class GeometricalBackground extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final borderSize =
        size.width / 7; // This is the size to fit 7 items
...
/// The goal of this widget is to create a final of geometric figures
/// It is Stateful because I want to maintain the state of it
/// The initState breaks the reference so that I can use it in multiple places
