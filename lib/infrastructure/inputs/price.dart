...
class Price extends FormzInput<double, PriceError> {
  ...
  String? get errorMessage {
    ...
    if ( displayError == PriceError.empty ) return 'The field is required';
    if ( displayError == PriceError.value ) return 'It must be a number greater than or equal to zero';
