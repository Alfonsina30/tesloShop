...
class Stock extends FormzInput<int, StockError> {
  ...
  String? get errorMessage {
    ...
    if ( displayError == StockError.value ) return 'It must be a number greater than or equal to zero';
    if ( displayError == StockError.format ) return 'It has no number format';
